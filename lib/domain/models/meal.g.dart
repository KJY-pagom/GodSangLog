...
const MealSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'clipId': PropertySchema(id: 2, name: r'clipId', type: IsarType.long),
...
int _mealEstimateSize(
  ...
  bytesCount += 3 + object.mealTime.length * 3;
...
void _mealSerialize(
  ...
  writer.writeLong(offsets[2], object.clipId);
  writer.writeDouble(offsets[3], object.fat);
  writer.writeString(offsets[4], object.mealTime);
...
Meal _mealDeserialize(
  ...
  object.clipId = reader.readLongOrNull(offsets[2]);
  object.fat = reader.readDouble(offsets[3]);
  object.id = id;
  object.mealTime = reader.readString(offsets[4]);
...
extension MealQueryFilter on QueryBuilder<Meal, Meal, QFilterCondition> {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> clipIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> clipIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> clipIdEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> clipIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> clipIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> clipIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> mealTimeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> mealTimeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> mealTimeContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> mealTimeMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> mealTimeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'mealTime', value: ''),
      );
    });
  }

  QueryBuilder<Meal, Meal, QAfterFilterCondition> mealTimeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'mealTime', value: ''),
      );
    });
  }
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> recordedAtEqualTo(
    DateTime value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> recordedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> recordedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> recordedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MealQuerySortBy on QueryBuilder<Meal, Meal, QSortBy> {
  ...
  QueryBuilder<Meal, Meal, QAfterSortBy> sortByClipId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'clipId', Sort.asc);
    });
  }

  QueryBuilder<Meal, Meal, QAfterSortBy> sortByClipIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterSortBy> sortByRecordedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordedAt', Sort.asc);
    });
  }

  QueryBuilder<Meal, Meal, QAfterSortBy> sortByRecordedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MealQuerySortThenBy on QueryBuilder<Meal, Meal, QSortThenBy> {
  ...
  QueryBuilder<Meal, Meal, QAfterSortBy> thenByClipId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'clipId', Sort.asc);
    });
  }

  QueryBuilder<Meal, Meal, QAfterSortBy> thenByClipIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'clipId', Sort.desc);
    });
  }
  ...
  QueryBuilder<Meal, Meal, QAfterSortBy> thenByRecordedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordedAt', Sort.asc);
    });
  }

  QueryBuilder<Meal, Meal, QAfterSortBy> thenByRecordedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recordedAt', Sort.desc);
    });
  }
...
extension MealQueryWhereDistinct on QueryBuilder<Meal, Meal, QDistinct> {
  ...
  QueryBuilder<Meal, Meal, QDistinct> distinctByClipId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QDistinct> distinctByMealTime({
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'mealTime', caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<Meal, Meal, QDistinct> distinctByRecordedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension MealQueryProperty on QueryBuilder<Meal, Meal, QQueryProperty> {
  ...
  QueryBuilder<Meal, int?, QQueryOperations> clipIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, String, QQueryOperations> mealTimeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, DateTime, QQueryOperations> recordedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'recordedAt');
    });
  }

  QueryBuilder<Meal, String, QQueryOperations> sourceProperty() {
    return QueryBuilder.apply(this, (query) {
